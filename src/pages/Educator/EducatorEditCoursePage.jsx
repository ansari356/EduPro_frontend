...
export default function EditCourse() {
	...
	return (
		<div className="profile-root">
			...
			{/* Main Content */}
			<div className="container py-5">
				<div className=" card border-0 mb-5 shadow-sm">
					<div className="container py-3">
					...
					<div className="col-lg-10">
						...
						<div className=" mt-5 py-5">
							<div>
								...
								>
									<h3 className="section-title fs-3">Course Content</h3>
									<button
										className="btn-edit-profile d-flex align-items-center"
								...
								{moduleLoading ? (
									...
									>
										...
										>
											...
											<button
												className="btn-edit-profileCurriculum"
						...
						<div className="card-body">
							<div className="row text-center mt-3">
								...
								<div className="col-md-3 mb-3">
									<div className="d-flex flex-column align-items-center">
										<i
											className="bi bi-play-circle text-success mb-2"
											style={{ fontSize: "1.5rem" }}
										></i>
