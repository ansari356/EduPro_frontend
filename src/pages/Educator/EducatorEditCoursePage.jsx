...
// import updateCoursesDetails from "../../apis/actions/educator/updateCoursesDetails";
...
export default function EditCourse() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Note: thumbnail upload would need separate handling since this endpoint uses JSON
      // You might need a separate endpoint for file uploads
